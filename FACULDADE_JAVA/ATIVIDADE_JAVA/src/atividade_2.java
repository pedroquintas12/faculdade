...
public class atividade_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("somos uma agencia de viagem inicialmente pequena com poucas opcoes de lugares, mas com o melhor serviço que voce vai ver!!!");
		...
		if(ResLugar==1) {
			...
			System.out.println("[3]Comida basica(feijão, arroz, carne, macarrao) - R$40.00");
			System.out.println("[4]Nada - R$0.00");
